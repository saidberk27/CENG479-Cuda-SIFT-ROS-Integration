#!/usr/bin/env python3
"""
Launch file for the parallel CUDA C++ SIFT/FLANN pipeline.
...
Usage:
  ros2 launch parallel sift_matching.launch.py
  ros2 launch parallel sift_matching.launch.py large_image:=/path/to/train.jpg query_image:=/path/to/query.jpg
"""
